...
<!--         <link rel="stylesheet" href="css/normalize.min.css">
    ...
    <body>
        ...
        <div class="header-container">
            ...
            <header class="wrapper clearfix">
                ...
                <div id="sidr"><nav><ul>
                    ...
                    <li><a href="feedme.htm">kick butt catering</a></li>
            ...
            <div id="navigation">
                <nav>
                        <a href="ourcoffees.htm">our coffees</a> <span class="red">|</span> 
                        <a href="ourstore.htm">our venue</a> <span class="red">|</span> 
                        <a href="online_store.htm">online store</a> <span class="red">|</span> 
                        <a href="menu.htm">menu</a> <span class="red">|</span> 
                        <a href="donation.htm">donation request</a> <span class="red">|</span> 
                        <a href="feedme.htm">kick butt catering</a><br />
                        <a href="barista_for_a_day.htm">classes</a> <span class="red">|</span> 
                        <a href="events.htm">events</a> <span class="red">|</span> 
                        <a href="aboutus.htm">about us</a> <span class="red">|</span> 
                        <a href="winners.htm">winners</a> <span class="red">|</span> 
                        <a href="http://facebook.com/kickbuttcoffee1">Facebook</a> <span class="red">|</span> 
                        <a href="http://twitter.com/kickbuttcoffee">Twitter</a> <span class="red">|</span> 
                        <a href="https://plus.google.com/108741565480066652893/posts">Google+</a> <span class="red">|</span> 
                        <a href="http://youtube.com/kickbuttcoffee">Youtube</a> <span class="red">|</span> 
                        <a href="https://maps.google.com/maps?ie=UTF-8&q=Kick+Butt+Coffee+Music+%26+Booze&fb=1&gl=us&hq=kick+butt+coffee+music+%26+booze&hnear=0x8644b599a0cc032f:0x5d9b464bd469d57a,Austin,+TX&cid=0,0,11079980876530906950&ei=FViFUoW_HomW2QXki4HwCw&ved=0CJkBEPwSMAs">map</a>
                </nav>
                </div>
            </header>
        </div>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <em><strong>
                <p>Welcome!</p>
                <p>Serving Lunch Monday thru Saturday 11am - 3pm</p>
                </strong></em>
                ...
                <p class="smallerer">
                    Open M-F 6:06am-10:10pm or Later<br />
                    Sat/Sun 8:08am-10:10pm or Later<br />
                </p>
                <p class="smallerer">
                    Comments, Questions, Suggestions?<br /> 
                    Contact the Owner Thomas Gohring at: <a href="mailto:thecoffeeguy@kickbuttcoffee.com">thecoffeeguy@kickbuttcoffee.com</a><br />
                </p>
                <p class="smallerer">
    ...
    <br />Join us the Last Saturday Night Every Month 8pm-10pm</p>
        ...
        the Perfect Blend</strong></p>
        <p class="smaller centered no-top-margin">by Lindsey Mullikin</p>
        <p class="smallerer med-lines">WHILE CHATTING WITH A BANK TELLER about the lack of coffee shops along Airport Boulevard, Thomas Gohring came up with what he thought was a kick-butt idea. Merging his love of martial arts (he also owns Master Gohring's Tai Chi &amp; Kung Fu ) with the community's need for a little pick-me-up, he opened Kick Butt Coffee Music &amp; Booze [February 11, 2008].</p>
        <p class="smallerer med-lines">Red walls, nunchuckus, bamboo and oriental fans illustrate the business ties to martial arts. The shop, which serves coffee, smoothies, pizza, breakfast frittatas, sandwiches, wine, beer and liquor, has round, cozy booths, a giant plasma screen TV and a Wii gaming system. Amenities at the new 2nd location include a giant projection screen, a swimming pool and a Wii.</p>
        <p class="smallerer med-lines">But Gohring wanted to build more of a nighttime business with a full bar as well. He asked his sister Joy, a stand-up comedian, to help start a weekly open mic night, and Kick Butt Comedy was born. The small coffee shop even opened its stage to over a 100 out-of-town musicians, including John Biz, Aim Low Kid and Christopher Denny, during South by Southwest.</p>
        <p class="smallerer med-lines">Gohring built off that music foundation with regular blues fusion dance nights, weekly open mic music, monthly Jazz Jam, and monthly belly dancing and drumming as well as regular hip-hop shows and rock concerts. While martial arts, coffee, comedy and music events may seem like random patchwork, it's all tied together with a single thread, Gohring explains. "It kind of boils down to one question that we ask ourselves every step of the way: Is it kick-butt?"</p>
        <hr />
        ...
        <p class=""><a href="mailto:thecoffeeguy@kickbuttcoffee.com">thecoffeeguy@KickButtCoffee.com</a> </p>
            <span class="red sep"> &bull; </span>
         <p class=""> 512-454-5425 </p>
             <span class="red sep"> &bull; </span>
          <p><a href="http://maps.google.com/maps/place?ie=UTF-8&q=kick+butt+coffee&near=Austin,+TX&fb=1&split=1&gl=us&ei=Wk2lSuuNNtWptgel7YD9Dw&oi=local_result&cid=11079980876530906950" target="_blank">5775 Airport Blvd, Austin TX </a></p>
        </div> <!-- .bottom -->
